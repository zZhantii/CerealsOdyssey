        ...
        <div id="carouselExampleRide" class="carousel slide my-3" data-bs-ride="true">
            <div class="carousel-inner col-sm-12 ">
                <div class="carousel-item active">
                    <div class="d-flex flex-lg-row flex-sm-column align-items-sm-center">
                        <img src="public/img/banners/banner2.webp" class="d-block w-75 object-fit-cover" alt="Banner1" height="540px">
